...
import quotesBg from "../../../public/images/Quotes Section.png";
import quotesDecor from "../../../public/images/Quotes Frame.png";
  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="relative h-125 flex items-center justify-center">
        ...
        <div className="z-3 absolute max-w-5xl top-[45%] -translate-y-1/2">
          <h2 className={`text-[69px] font-semibold text-[#21C27F] ${archivo.className} text-center`}>
            Built this before my brain did a factory reset.
          </h2>
        </div>
      </div>
    </section>
